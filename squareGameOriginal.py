...
def checkForCollision():
    global player
    if (player.xcor() - enemy1.xcor()) >= -20 and (player.xcor() - enemy1.xcor()) <= 20 and (player.ycor() - enemy1.ycor()) >= -20 and (player.ycor() - enemy1.ycor()) <= 20:return True
    elif (player.xcor() - enemy2.xcor()) >= -20 and (player.xcor() - enemy2.xcor()) <= 20 and (player.ycor() - enemy2.ycor()) >= -20 and (player.ycor() - enemy2.ycor()) <= 20:return 1
    elif (player.xcor() - enemy3.xcor()) >= -20 and (player.xcor() - enemy3.xcor()) <= 20 and (player.ycor() - enemy3.ycor()) >= -20 and (player.ycor() - enemy3.ycor()) <= 20:return 1
    elif (player.xcor() - enemy4.xcor()) >= -20 and (player.xcor() - enemy4.xcor()) <= 20 and (player.ycor() - enemy4.ycor()) >= -20 and (player.ycor() - enemy4.ycor()) <= 20:return 1
    elif (player.xcor() - enemy5.xcor()) >= -20 and (player.xcor() - enemy5.xcor()) <= 20 and (player.ycor() - enemy5.ycor()) >= -20 and (player.ycor() - enemy5.ycor()) <= 20:return 1
    elif (player.xcor() - enemy6.xcor()) >= -20 and (player.xcor() - enemy6.xcor()) <= 20 and (player.ycor() - enemy6.ycor()) >= -20 and (player.ycor() - enemy6.ycor()) <= 20:return 1
    elif (player.xcor() - enemy7.xcor()) >= -20 and (player.xcor() - enemy7.xcor()) <= 20 and (player.ycor() - enemy7.ycor()) >= -20 and (player.ycor() - enemy7.ycor()) <= 20:return 1
    elif (player.xcor() - enemy8.xcor()) >= -20 and (player.xcor() - enemy8.xcor()) <= 20 and (player.ycor() - enemy8.ycor()) >= -20 and (player.ycor() - enemy8.ycor()) <= 20:return 1
    elif (player.xcor() - enemy9.xcor()) >= -20 and (player.xcor() - enemy9.xcor()) <= 20 and (player.ycor() - enemy9.ycor()) >= -20 and (player.ycor() - enemy9.ycor()) <= 20:return 1
    elif (player.xcor() - enemy0.xcor()) >= -20 and (player.xcor() - enemy0.xcor()) <= 20 and (player.ycor() - enemy0.ycor()) >= -20 and (player.ycor() - enemy0.ycor()) <= 20:return 1
    else:return 0

def playerMovement():
    global up, down, left, right
    if up == 1:player.goto(player.xcor() + 10, player.ycor())
    if down == 1:player.goto(player.xcor() - 10, player.ycor())
    if left == 1:player.goto(player.xcor(), player.ycor() - 10)
    if right == 1:player.goto(player.xcor(), player.ycor() + 10)
    # this took way too long to debug because i forgot a pair of parenthesis here and for some reason python called the error on the function called after it instead of this one
    if player.xcor() > 310:player.goto(310, player.ycor())
    if player.xcor() < -310:player.goto(-310, player.ycor())
    if player.ycor() > 310:player.goto(player.xcor(), 310)
    if player.ycor() < -310:player.goto(player.xcor(), -310)
